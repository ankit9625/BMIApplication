...
class MainActivity : AppCompatActivity(), View.OnClickListener{
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            id.sub_option_dail -> {
                val activitycustomdialogbinding =
                    ActivityCustomDialogForTakeAnumberBinding.inflate(layoutInflater)
                ...
                activitycustomdialogbinding.btnCall.setOnClickListener {
                    customdiaolonumberinput =
                        activitycustomdialogbinding.etNumberInput.editText?.text.toString()
    ...
    override fun onClick(v: View?) {
        ...
        if (isClear) {
            ...
            if (binding.edtinputweight.text.toString()
                    .isNotEmpty() && binding.edtinputheight.text.toString().isNotEmpty()
            ) {
                ...
                if (TextUtils.isEmpty(binding.edtinputweight.text.toString()) && TextUtils.isEmpty(
                    ...
                    Toast.makeText(
                        this,
                        " Please Fill All Fields Very carefully ",
                        Toast.LENGTH_LONG
                    )
                        .show()
